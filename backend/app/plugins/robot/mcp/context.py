        ...
        [
            ...
            *_robot_identity_context_lines(reply_target, conversation_type),
            ...
            (
                ...
                "or recurring group context. Active execution state belongs to "
                "the task queue, but independently important task information "
                "may still be remembered. Call `mcp_robot_recall_memory` for "
                "stable facts, preferences, tasks, errors, reusable "
