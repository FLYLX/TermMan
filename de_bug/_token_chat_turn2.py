# -*- coding: utf-8 -*-
"""Second one-turn chat token measurement (variance check)."""
...
p1,c1,t1,n1 = totals()
print(f"RESULT turn2: calls +{n1-n0} | prompt +{p1-p0} | completion +{c1-c0} | total +{t1-t0} | {int(time.time()-t_start)}s", flush=True)
