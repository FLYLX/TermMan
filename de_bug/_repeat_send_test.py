# -*- coding: utf-8 -*-
"""Adversarial: induce split/repeat sends. Count outbox sends + LLM calls."""
...
payload = {
    ...
    "text": "两个问题：第一，1+1等于？第二，2+2等于？请分开回答我这两个问题",
...
print(f"OUTBOX new lines={len(new)}, SENDS={len(sends)}", flush=True)
